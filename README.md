# Learning AngularJS (1.4.8)
**IMPORTANT:** AngularJS 1.X has been renamed to AngularJS. It will be moving to Long Term Support (LTS) mode on July 1st 2018.
...
They are applied to an expression by piping them. For example, `{{ someExpression | currency }}`. Which will format it as currency.
